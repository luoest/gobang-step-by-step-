...
mn = Menu(tk)
mnFile = Menu(mn)
mn.add_cascade(label = 'menu', menu = mnFile)
mnFile.add_command(label = 'back', command = back)
mnFile.add_command(label = 'restart', command = restart)
mnFile.add_command(label = 'close', command = close)

mn.add_command(label = '关闭', command = close)
